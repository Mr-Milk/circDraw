...
urlpatterns = [
    ...
    url(r'^test_display/tools_file1$', views.handle_file1, name="tools_file1"),
    url(r'^test_display/tools_file2$', views.handle_file2, name="tools_file2"),
    url(r'^test_display/tools_file3$', views.handle_file3, name="tools_file3"),
    url(r'^test_display/tools_file4$', views.handle_file4, name="tools_file4"),
    url(r'^test_display/tools_file5$', views.handle_file5, name="tools_file5")
]
